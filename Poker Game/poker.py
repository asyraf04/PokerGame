...
# NOTE: The following implementation is a sample and will not run without 
# the necessary model files (e.g., SAV files).
## ---------------- FILL HERE ---------------------------------
import pickle
...
import pandas as pd
cand_hands = pd.read_csv('poker-hand-testing-1.csv')
